...
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); const ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7._animationDone($event); });
...
MatStepHeader.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: MatStepHeader, selectors: [["mat-step-header"]], hostAttrs: ["role", "tab", 1, "mat-step-header"], inputs: { state: "state", label: "label", iconOverrides: "iconOverrides", index: "index", selected: "selected", active: "active", optional: "optional" }, decls: 9, vars: 16, consts: [["mat-ripple", "", 1, "mat-step-header-ripple", 3, "matRippleTrigger"], [3, "ngSwitch"], [3, "ngSwitch", 4, "ngSwitchCase"], [1, "mat-step-label"], [3, "ngTemplateOutlet", 4, "ngIf"], ["class", "mat-step-text-label", 4, "ngIf"], ["class", "mat-step-optional", 4, "ngIf"], [3, "ngTemplateOutlet", "ngTemplateOutletContext", 4, "ngSwitchCase"], ["class", "mat-step-icon-content", 4, "ngSwitchDefault"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "mat-step-icon-content"], [3, "ngTemplateOutlet"], [1, "mat-step-text-label"], [1, "mat-step-optional"]], template: function MatStepHeader_Template(rf, ctx) { if (rf & 1) {
...
MatStepperModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [MatStepperIntl, ErrorStateMatcher], imports: [[
            MatCommonModule,
            CommonModule,
            PortalModule,
            MatButtonModule,
